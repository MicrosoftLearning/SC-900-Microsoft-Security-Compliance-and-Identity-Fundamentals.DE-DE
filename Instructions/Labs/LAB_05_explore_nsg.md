...
1. Wählen Sie auf der Seite „NSG-SC900“ im linken Navigationsbereich unter „Einstellungen“ die Option **Netzwerkschnittstellen** aus.
    ...
    2. Wählen Sie im Feld für Netzwerkschnittstellenzuordnungen den **Abwärtspfeil** aus, wählen Sie **sc900-winvmXXX** aus und dann unten im Fenster **OK**. Sobald der NSG die Schnittstelle zugeordnet ist, wird sie in der Liste angezeigt.
...
1. Wählen Sie oben auf der Seite die Option **Hinzufügen** aus. Geben Sie auf der Seite „Eingehende Sicherheitsregel hinzufügen“ die folgenden Einstellungen an:
    ...
    1. Dienst:  **RDP**
    1. Aktion:  **Zulassen**
    1. Priorität: **1.000**. Hinweis: Regeln mit niedrigeren Zahlen besitzen höhere Priorität und werden zuerst verarbeitet.
...
1. Sobald die Regel bereitgestellt wurde, wird sie in der Liste der eingehenden Regeln angezeigt (Möglicherweise müssen Sie den Bildschirm aktualisieren). Für die neu hinzugefügte Regel wird ein Warnzeichen angezeigt.  Wie oben bereits gesagt, verwenden wir RDP nur zu Testzwecken und zur Veranschaulichung der Funktionalität der NSG. Wählen Sie die neu hinzugefügte Regel aus.
...
1. Wählen Sie oben auf der Seite die Option **Verbinden** und dann **RDP** aus.
...
1. Wählen Sie im daraufhin angezeigten Popupfenster **Datei öffnen** aus.

1. Ein Fenster „Remotedesktopverbindung“ wird geöffnet. Wählen Sie **Verbinden** aus.

1. Anschließend werden Sie zur Eingabe Ihrer Anmeldeinformationen aufgefordert.  Geben Sie den Benutzernamen und das Kennwort ein (siehe Registerkarte „Ressourcen“ im Lab-Anweisungsbereich).
...
1. Nach einigen Sekunden wird auf dem Willkommensbildschirm ein Fenster angezeigt, in dem Sie Datenschutzeinstellungen für Ihr Gerät auswählen können. Wählen Sie **Akzeptieren** aus.  Wählen Sie im Fenster „Netzwerke“ die Option **Nein** aus.

1. Testen Sie die ausgehende Konnektivität mit dem Internet über die VM, wenn die VM ausgeführt wird und aktiv ist.
...
1. Sie sollten sich auf der Seite „SC900-WinVM | Netzwerk“ befinden. Wenn Sie die Browserregisterkarte zuvor geschlossen haben, wählen Sie oben auf der Seite die blaue Suchleiste aus, und wählen Sie „Virtuelle Computer“ und dann die VM **SC900-WinVM** aus. Wählen Sie anschließend **Netzwerk** aus.
